...
const Hero = () => (
  <header className="flex flex items-center justify-around min-h-[50vh]">
    ...
    <div className="flex flex-col gap-6 items-center justify-center text-foreground group transition-all duration:1000 ease-in">
      <h1 className="w-max font-black text-8xl text-center">Hello, World!</h1>
